package cj.blogapp.repository;

import cj.blogapp.BlogApplicationApp;
import cj.blogapp.config.Constants;
import cj.blogapp.config.audit.AuditEventConverter;
import cj.blogapp.domain.PersistentAuditEvent;
...
import static cj.blogapp.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
